...
for (const child of dom.children) {
    ...
    switch (child.tagName.toLowerCase()) {
        case 'h1': embed.setTitle(child.innerHTML); break
        case 'h2': embed.setTitle('§ ' + child.innerHTML); break
        case 'ol': let i = 0; child.querySelectorAll('li').forEach(li => {
